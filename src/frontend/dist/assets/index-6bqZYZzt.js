        ...
        !collapsed && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { overflowX: "auto" }, children: [
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          ...
                          children: fmtPrice$1(pred.currentPrice)
                        }
                      ),
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          style: {
                            fontFamily: "var(--font-mono)",
                            fontSize: 11,
                            color: pred.predictedMove >= 0 ? "var(--cb-green)" : "var(--cb-red)"
                          },
                          children: fmtPrice$1(pred.predictedPrice)
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "div",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: "⚠️ DISCLAIMER: Predictions are algorithmic estimates for demo purposes only. Not financial advice."
            }
          )
        ] })
      ]
...
function computePrediction(coinId, closes) {
  ...
  const composite = rsiScore * 0.25 + emaScore * 0.3 + macdScore * 0.3 + bbScore * 0.15;
...
function use15MinPrediction(getPriceHistory, coinIds) {
  ...
  const [nextRefreshIn, setNextRefreshIn] = reactExports.useState(PREDICTION_INTERVAL);
  const [lastUpdated, setLastUpdated] = reactExports.useState("");
  const refreshCounterRef = reactExports.useRef(PREDICTION_INTERVAL);
  const recalculate = reactExports.useCallback(() => {
    const preds = coinIds.map((id) => {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "main",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { style: { padding: 16 }, className: "sidebar-right", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                "data-ocid": "pnl.panel",
