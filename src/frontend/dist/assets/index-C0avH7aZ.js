...
function computePrediction(coinId, closes) {
  ...
  if (macdLine > sigLine && hist > 0)
    macdScore = Math.min(1, hist / price * 5e3);
  else if (macdLine < sigLine && hist < 0)
    macdScore = Math.max(-1, hist / price * 5e3);
...
function App() {
  ...
  const computeIndicators = reactExports.useCallback((coinId) => {
    ...
    const macdCls = m.macd > 0 && m.hist > 0 ? "bullish" : m.macd < 0 && m.hist < 0 ? "bearish" : "neutral-i";
  ...
  reactExports.useEffect(() => {
    ...
    setTimeout(() => generateSignal(activeCoinId), 2e3);
  }, []);
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    style: {
                      ...
                      background: signal.sig === "buy" ? "radial-gradient(ellipse at top left, rgba(0,255,136,0.08), transparent 70%), linear-gradient(135deg, #030f0a, #020810)" : signal.sig === "sell" ? "radial-gradient(ellipse at top left, rgba(255,48,96,0.08), transparent 70%), linear-gradient(135deg, #0f0308, #020810)" : "radial-gradient(ellipse at top left, rgba(255,215,0,0.05), transparent 70%), linear-gradient(135deg, #0d0c02, #020810)",
                      boxShadow: signal.sig === "buy" ? "0 0 40px rgba(0,255,136,0.08), inset 0 0 40px rgba(0,255,136,0.03)" : signal.sig === "sell" ? "0 0 40px rgba(255,48,96,0.08), inset 0 0 40px rgba(255,48,96,0.03)" : "none",
                      transition: "all 0.6s"
                    },
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          ...
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "div",
                              {
                                ...
                                children: "⚡ BOT SIGNAL — 12MIN INTERVAL"
                              }
                            ),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs(
                              "div",
                          ...
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "div",
                              {
                                ...
                                children: "📊 PRICE CHART + SIGNALS"
                              }
                            ),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 6 }, children: ["1M", "5M", "15M"].map((lbl, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "div",
                              {
